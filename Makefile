...
obj/count_words.o: ./src/count_words.cc ./src/segmenter.h ./src/string_view.h ./src/word_counter.h ./src/string_view.h ./src/segmenter.h ./src/string_view.h gen/namebo.pb.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix protobuf)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix glog)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix gflags)/include -I$(shell brew --prefix glog)/include -Igen -o $@ -c ./src/count_words.cc

bin/dump: obj/dump.o obj/namebo.o
	mkdir -p bin && g++ -g -o $@ $^ -lprotobuf -L$(shell brew --prefix protobuf)/lib -lgflags -L$(shell brew --prefix gflags)/lib -lglog -L$(shell brew --prefix glog)/lib -lleveldb -L$(shell brew --prefix leveldb)/lib

obj/dump.o: ./src/dump.cc gen/namebo.pb.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix protobuf)/include -I$(shell brew --prefix gflags)/include -I$(shell brew --prefix glog)/include -I$(shell brew --prefix leveldb)/include -Igen -o $@ -c ./src/dump.cc

bin/generate: obj/generate.o obj/namebo.o
	mkdir -p bin && g++ -g -o $@ $^ -lprotobuf -L$(shell brew --prefix protobuf)/lib -lgflags -L$(shell brew --prefix gflags)/lib -lglog -L$(shell brew --prefix glog)/lib -lleveldb -L$(shell brew --prefix leveldb)/lib

obj/generate.o: ./src/generate.cc gen/namebo.pb.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix protobuf)/include -I$(shell brew --prefix gflags)/include -I$(shell brew --prefix glog)/include -I$(shell brew --prefix leveldb)/include -Igen -o $@ -c ./src/generate.cc
...
obj/generate_words.o: ./src/generate_words.cc ./src/segmenter.h ./src/string_view.h ./src/word_counter.h ./src/string_view.h ./src/segmenter.h ./src/string_view.h gen/namebo.pb.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix protobuf)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix glog)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix gflags)/include -I$(shell brew --prefix glog)/include -Igen -o $@ -c ./src/generate_words.cc

obj/namebo.o: gen/namebo.pb.cc gen/namebo.pb.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix protobuf)/include -Igen -o $@ -c gen/namebo.pb.cc

gen/namebo.pb.cc gen/namebo.pb.h: src/namebo.proto
	mkdir -p gen && $(shell brew --prefix protobuf)/bin/protoc --proto_path=src --cpp_out=gen $^

obj/segmenter.o: ./src/segmenter.cc ./src/segmenter.h ./src/string_view.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix leveldb)/include -Igen -o $@ -c ./src/segmenter.cc

bin/segmenter_test: obj/segmenter_test.o obj/segmenter.o obj/string_view.o
	mkdir -p bin && g++ -g -o $@ $^ -lleveldb -L$(shell brew --prefix leveldb)/lib -lgtest -L$(shell brew --prefix gtest)/lib -lgtest_main

obj/segmenter_test.o: ./src/segmenter_test.cc ./src/segmenter.h ./src/string_view.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix gtest)/include -Igen -o $@ -c ./src/segmenter_test.cc

obj/string_view.o: ./src/string_view.cc ./src/string_view.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix leveldb)/include -Igen -o $@ -c ./src/string_view.cc
...
obj/word_counter.o: ./src/word_counter.cc ./src/word_counter.h ./src/string_view.h ./src/segmenter.h ./src/string_view.h gen/namebo.pb.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix protobuf)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix glog)/include -I$(shell brew --prefix leveldb)/include -Igen -o $@ -c ./src/word_counter.cc
...
bin/word_counter_test: obj/word_counter_test.o obj/segmenter.o obj/string_view.o obj/word_counter.o obj/string_view.o obj/segmenter.o obj/string_view.o obj/namebo.o
	mkdir -p bin && g++ -g -o $@ $^ -lleveldb -L$(shell brew --prefix leveldb)/lib -lleveldb -L$(shell brew --prefix leveldb)/lib -lleveldb -L$(shell brew --prefix leveldb)/lib -lprotobuf -L$(shell brew --prefix protobuf)/lib -lleveldb -L$(shell brew --prefix leveldb)/lib -lleveldb -L$(shell brew --prefix leveldb)/lib -lglog -L$(shell brew --prefix glog)/lib -lleveldb -L$(shell brew --prefix leveldb)/lib -lgtest -L$(shell brew --prefix gtest)/lib -lgtest_main
...
obj/word_counter_test.o: ./src/word_counter_test.cc ./src/segmenter.h ./src/string_view.h ./src/word_counter.h ./src/string_view.h ./src/segmenter.h ./src/string_view.h gen/namebo.pb.h
	mkdir -p obj && g++ -g -std=c++11 -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix protobuf)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix glog)/include -I$(shell brew --prefix leveldb)/include -I$(shell brew --prefix gtest)/include -Igen -o $@ -c ./src/word_counter_test.cc
